...
> **`FSV3007` and `FPL1003` spectrum analyzers** and the Aim-TTi **`TGR6000`
> 6 GHz RF signal generator**, each built from reusable per-topic menus over a
> shared base. Next: more drivers (VNAs). Public APIs may still change
> before 1.0.
