...
A spectrum-analyzer driver assembled from the reusable R&S menus in this
package (:mod:`frequency`, :mod:`bandwidth`, :mod:`sweep`, :mod:`amplitude`,
:mod:`trace`, :mod:`marker`, :mod:`system`). Other R&S FSV-family analyzers
(e.g. the FPL1003) can be built by composing the same menus, so the shared
command logic lives in one place rather than being copy-pasted per instrument.
...
class FSV3007(BaseInstrument):
    """Driver for the R&S FSV3007 spectrum analyzer (TCP/IP)."""
